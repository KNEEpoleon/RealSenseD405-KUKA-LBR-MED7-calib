...
class RobotTransformNode(Node):
    ...
    def get_full_transformation_matrix(self):
        ...
        link_order = [
            ('lbr_link_0', 'lbr_link_1'), ('lbr_link_1', 'lbr_link_2'), 
            ('lbr_link_2', 'lbr_link_3'), ('lbr_link_3', 'lbr_link_4'), 
            ('lbr_link_4', 'lbr_link_5'), ('lbr_link_5', 'lbr_link_6'), 
            ('lbr_link_6', 'lbr_link_7'), 
            ('lbr_link_7', 'lbr_link_ee'),
        ]
